                ...
                <div className="flex flex-col lg:flex-row items-center justify-start gap-x-28 gap-y-11">
                    <div className="md:px-[22px] lg:px-0 lg:w-7/12 w-full order-1 ">
                        <div className="  false "><div className="">
                            <h2 className="text-[24px] lg:text-5xl font-extrabold md:leading-[44px] lg:leading-[56px]  text-secondary-100  md:mb-6 f-f-Lato">{heading}</h2>
                            <p className="   text-white md:text-2xl text-xl f-f-Lato font-bold md:leading-9  ">{subheading}</p>
                            <p className="text-white text-[16px] text-justify f-f-Lato md:leading-[30px]  font-normal  md:mt-5 md:mb-12 mt-2">{paragraph}</p>
