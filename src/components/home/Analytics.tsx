    ...
    return (
        <div className='w-full  py-16 flex flex-col justify-center items-center'>
            ...
            <motion.div ref={ref2} initial="hidden"
                ...
                variants={containerVariants} className="w-full flex md:space-y-0 md:flex-row flex-col space-y-5 md:space-x-10 py-10 justify-center items-center">
                <motion.div variants={cardVariants} className="w-full rounded-lg flex flex-col justify-start items-start h-full">
                    <h2 className="text-4xl font-bold mb-4 text-white">Unleash Your Potential with YouTube Artist Promotion</h2>
                    <p className="mb-4 text-paragraph-200 text-sm">
            ...
            <motion.div ref={ref3} initial="hidden"
                ...
                variants={containerVariants} className="analytics-section-3 w-full flex md:space-x-10 md:space-y-0 space-y-5 flex-col md:flex-row py-10 justify-center items-center">
                <motion.div variants={cardVariants} className="w-full">
                    <img src="/images/meet.png" alt="Team Image" className="rounded-lg w-full xl:h-96 lg:h-80 md:h-60 h-56" />
                </motion.div>
                <motion.div variants={cardVariants} className="w-full rounded-lg flex flex-col justify-start items-start h-full">
                    <p className='text-paragraph-200 text-xs my-1'>BOOK A FREE MEETING</p>
                    <h2 className="xl:text-4xl lg:text-3xl md:text-2xl text-xl font-bold mb-4 text-white">Unlock Your Potential with a Free Consultation</h2>
                    <p className="mb-4 text-paragraph-200 text-sm">Discover how our tailored solutions can drive growth and inspire change for your business. Book a free meeting with our experts and explore the endless possibilities at your fingertips.</p>
                    <ul className='grid md:grid-cols-2 grid-cols-1 gap-3 mb-5 xl:text-sm text-xs'>
