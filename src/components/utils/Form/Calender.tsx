...
export function Calendar({ selectedDate, setSelectedDate }: { selectedDate: Date, setSelectedDate: React.Dispatch<React.SetStateAction<Date>> }) {
                            ...
                            >
                                <button
                                    className={cn({
                                        ...
                                        "bg-tertiary-200": isSameDay(day, today),
                                        "text-white": isSameDay(day, today),
                                        "bg-secondary-100": isSameDay(day, selectedDate),
                                        "text-black": isSameDay(day, selectedDate),
                                    })}
